...
def create_synthetic_setonet_model(args, device):
    ...
    model = SetONet(
        ...
        quad_key_hidden=getattr(args, "son_quad_key_hidden", None),
        quad_key_layers=getattr(args, "son_quad_key_layers", 3),
        quad_phi_activation=getattr(args, "son_quad_phi_activation", "softplus"),
        quad_value_mode=getattr(args, "son_quad_value_mode", "linear_u"),
