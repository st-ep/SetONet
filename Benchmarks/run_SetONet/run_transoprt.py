...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(description="Train SetONet for optimal transport velocity field prediction.")
...
def create_model(args, device):
    """Create SetONet model for optimal transport velocity field prediction."""
...
def main():
    ...
    # Evaluate model
    print("\nEvaluating model...")
    evaluate_model(model, dataset, transport_dataset, device, n_test_samples=100)
